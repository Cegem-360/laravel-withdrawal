...
<head>
    ...
    <title>{{ __('elallas::elallas.page_title') }}</title>
</head>
<body style="font-family:system-ui,sans-serif;max-width:640px;margin:2rem auto;padding:0 1rem;line-height:1.6;color:#1a2433">
    <h1>{{ __('elallas::elallas.template_heading') }}</h1>
    <p style="color:#556">{{ __('elallas::elallas.template_note') }}</p>
    <p>{{ __('elallas::elallas.intro') }}</p>
